...
<script type="text/javascript">
	...
	$(function(){
        ...
        $("#modifyPwdBtn").click(function(){
            ...
            $.ajax({
                url:'settings/qx/user/modifyPwd',
                data:{
                    oldPwd : oldPwd,
                    newPwd : newPwd,
    ...
    function queryUserInfo() {
        //发送请求
        $.ajax({
            url:'settings/qx/user/queryUser',
            data:{},
            type:'post',
            success:function(data){
                var htmlStr = "";
                htmlStr += "姓名：<b>"+data.name+"</b><br><br>";
                htmlStr += "登录帐号：<b>"+data.loginAct+"</b><br><br>";
                htmlStr += "创建时间：<b>"+data.createTime+"</b><br><br>";
                htmlStr += "修改时间：<b>"+data.editTime+"</b><br><br>";
                htmlStr += "允许访问IP：<b>"+data.allowIps+"</b>";
                $("#userInfoDiv").html(htmlStr);
		...
		<div class="modal-dialog" role="document" style="width: 30%;">
			<div class="modal-content">
				...
				<div class="modal-body">
                    ...
                    <div id="userInfoDiv" style="position: relative; left: 40px;">
		...
		<div class="modal-dialog" role="document" style="width: 70%;">
			<div class="modal-content">
				...
				<div class="modal-footer">
                    ...
                    <button id="modifyPwdBtn" type="button" class="btn btn-primary">更新</button>
				</div>
			</div>
		</div>
	</div>
		...
		<div style="position: absolute; top: 15px; right: 15px;">
			<ul>
				<li class="dropdown user-dropdown">
                    <%--<li class="dropdown user-dropdown" style="margin-right:120px;">--%>
					...
					<ul class="dropdown-menu">
                        ...
                        <li><a onclick="queryUserInfo()" href="javascript:void(0)"><span class="glyphicon glyphicon-file"></span> 我的资料</a></li>
	...
	<div id="center" style="position: absolute;top: 50px; bottom: 30px; left: 0px; right: 0px;">
		...
		<div id="navigation" style="left: 0px; width: 18%; position: relative; height: 100%; overflow:auto;">
			...
			<ul id="no1" class="nav nav-pills nav-stacked">
				...
				<li class="liClass"><a href="workbench/activity/index.jsp" target="workareaFrame"><span class="glyphicon glyphicon-play-circle"></span> 活动</a></li>
				...
				<li class="liClass"><a href="workbench/message/index.jsp" target="workareaFrame"><span class="glyphicon glyphicon-list"></span> 短信息</a></li>
                ...
                <li class="liClass">
                    ...
                    <ul id="no2" class="nav nav-pills nav-stacked collapse">
                        <li class="liClass"><a href="workbench/chart/activity/index.jsp" target="workareaFrame">&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-chevron-right"></span> 活动统计图表</a></li>
